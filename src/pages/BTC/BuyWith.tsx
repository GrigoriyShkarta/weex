	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]'>
			<div className='text-[#8b8b8e] text-[14px]'>
				Can't Find Bitcoin (BTC) in the "Buy Crypto" Section?
			</div>
			...
			<p className='text-[14px] mt-[16px]'>
				If you don't see Bitcoin (BTC) listed in the "Buy Crypto" section, don't
				worry! You can still easily buy it on WEEX using USDT (Tether) or
