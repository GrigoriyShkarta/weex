...
const HowToBuy = () => {
	...
	const guideSteps = [
		...
		},
		{
			...
			description:
				'Select Bitcoin, enter the amount you want to buy, select your payment method, and review the exchange rate before confirming.',
		...
		},
		{
			...
			title: 'View Your WXT',
			description:
				'Once successful, you can view your Bitcoin by going to "Assets" > "Buy Crypto" > "Records" in the upper left corner.',
	...
	return (
		<div id='HowTuBuy' className='mt-[80px] max-sm:mt-[40px]'>
			<h2 className='font-[500] text-[20px] max-sm:text-[4.2vw]'>
				Buy Bitcoin on WEEX: A Step-by-Step Guide
			</h2>
