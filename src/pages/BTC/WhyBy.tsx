	...
	const whyBuyItems = [
		{
			...
			title: 'Popularity',
			description:
				"With many holders already onboard, Bitcoin is becoming a popular choice for those diving into the crypto universe. Don't miss your chance to be part of this growing community and discover the potential of Bitcoin!",
		},
		{
			icon: 'https://www.weex.com/_pages/img/subtract.8421161.png',
			title: 'Trade Your Way',
			description:
				'Bitcoin gives you the freedom to trade on your terms. Use it for spot and futures trading on both centralized and decentralized exchanges, and put yourself in control of your crypto experience.',
		},
	]
