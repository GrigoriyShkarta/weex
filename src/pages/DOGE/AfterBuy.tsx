...
const AfterBuy: React.FC = () => {
	const options = [
		...
		},
		{
			title: 'Spend',
			description:
				'Use Dogecoin for direct payments where accepted, or get a Crypto Pay Card (like Bitpay) to instantly convert your crypto to cash for use at millions of merchants or to buy gift cards.',
		},
		{
		...
		},
		{
			...
			description:
				'Research if Dogecoin is used in any platforms, apps, games, or services.',
		},
	]
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WhatCanIDo'>
			<h2 className='text-[32px] font-[500] max-sm:text-[6.4vw]'>
				What Can I Do After I Buy Dogecoin (DOGE)?
			</h2>
