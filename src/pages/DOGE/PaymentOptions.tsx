...
const PaymentOptions: React.FC = () => {
	const paymentMethods = [
		...
		},
		{
			...
			description:
				'The fastest way to buy Dogecoin using your credit or debit card on your mobile device.',
		},
		{
			imageSrc: '	https://www.weex.com/_pages/img/credit.df78827.png',
			title: 'Credit/Debit Card',
			description:
				'A quick and easy way to buy Dogecoin using your Visa or Mastercard through our partner, ALCHEMY.',
		},
		{
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='BuyingWEEX'>
			<h2 className='text-[32px] font-[500] max-sm:text-[6.4vw]'>
				Buying Dogecoin on WEEX: Your Payment Options
			</h2>
