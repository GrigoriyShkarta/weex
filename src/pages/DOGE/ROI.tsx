	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WEEXToken'>
			<h2 className='text-[32px] font-[500] max-sm:text-[6.4vw]'>
				Dogecoin ROI & Earning Potential This Week
			</h2>
			<p className='mt-[16px]'>
				See how Dogecoin has performed recently. The table below shows the
				hourly, daily, and 7-day ROI for Dogecoin.
			</p>
			...
			<p className='mt-[16px] text-[14px]'>
				This data reflects the ROI of Dogecoin over different timeframes. While
