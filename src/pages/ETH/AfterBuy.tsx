...
const AfterBuy: React.FC = () => {
	const options = [
		...
		},
		{
			title: 'Spend',
			description:
				'Use Ethereum for direct payments where accepted, or get a Crypto Pay Card (like Bitpay) to instantly convert your crypto to cash for use at millions of merchants or to buy gift cards.',
		},
		{
		...
		},
		{
			...
			description:
				'Research if Ethereum is used in any platforms, apps, games, or services.',
		},
	]
