...
const BuyWithWeex: React.FC = () => {
	const items = [
		...
		},
		{
			...
			description:
				'Join over 1000000 users who choose WEEX for their Ethereum trades.',
		},
		{
			imageUrl: 'https://www.weex.com/_pages/img/buy-weex4.872657e.png',
			title: 'Easy 5-Minute Purchase',
			description: 'Buy Ethereum in just minutes with our intuitive platform.',
		},
		{
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WhyBuyWEEX'>
			...
			<p className='mt-[16px] text-[14px]'>
				...
				buying Ethereum today on WEEX and enjoy the best crypto trading
				experience.
			</p>
			...
			<p className='mt-[16px] text-[14px]'>
				Experience the WEEX difference! We make buying Ethereum secure, simple,
				and rewarding.
			</p>
		</div>
	)
