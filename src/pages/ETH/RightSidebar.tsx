...
const RightSidebar: React.FC = () => {
	...
	const calculateWxt = () => {
		...
		const wxtPrice = data['ETH-USD'].PRICE
	...
	return (
		<div className='w-[296px] max-sm:w-full max-sm:mt-[14.9vw]'>
			{/* Converter Section */}
			<div className=''>
				<h2 className='text-[18px] font-[500]'>Sign Up to Buy Ethereum</h2>
			...
			<div className='mt-[56px]'>
				<div className='flex items-center gap-[16px]'>
					...
					/>
					<h2 className='text-[18px] font-[700]'>Ethereum Price</h2>
				</div>

				<div className='flex items-center flex-wrap mt-[16px] gap-[29px]'>
					<h2 className='text-[32px] font-[700]'>${data['ETH-USD'].PRICE}</h2>
				</div>

				<p className='mt-[16px] p-[16px] text-[14px] rounded-[16px] border border-[#282828] text-[#d1d1d2]'>
					The current Ethereum price is{' '}
					<span className='font-bold'>${data['ETH-USD'].PRICE}</span>, with a
					...
					Ethereum market cap currently sits at{' '}
