...
const HowToBuyETH: React.FC = () => {
	...
	const navigationItems = [
		...
		{
			id: 'WhyBuy',
			title: 'Why Buy WEEX Ethereum (ETH)',
		},
		{
			id: 'WEEXToken',
			title: 'Ethereum ROI & Earning Potential This Week',
		},
		{
			id: 'BuyWEEX',
			title: 'Buy Ethereum (ETH) Using Decentralized Exchanges',
		},
		{
			id: 'WhyBuyWEEX',
			title: 'Why Buy Ethereum With WEEX?',
		},
		{
			id: 'BuyingWEEX',
			title: 'Buying Ethereum on WEEX: Your Payment Options',
		},
		{
			id: 'WhatCanIDo',
			title: 'What Can I Do After I Buy Ethereum (ETH)',
		},
		{
			id: 'FAQ',
			title: 'FAQ',
				...
				<div className='w-[856px] pb-[100px] max-sm:w-full max-sm:pb-0'>
					...
					<div>
						...
						<h1 className='mt-[16px] text-[32px] font-[500] max-sm:mt-[4.2vw] max-sm:text-[6.4vw]'>
							A Guide on Where and How to Buy Ethereum (ETH)
						</h1>
						<p className='mt-[16px] max-sm:mt-[4.2vw] max-sm:text-[3.2vw]'>
							You can buy Ethereum on WEEX. Create your free account and connect
