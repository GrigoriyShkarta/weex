...
const AfterBuy: React.FC = () => {
	const options = [
		...
		},
		{
			title: 'Trade',
			description:
				'Trade WXT for other cryptocurrencies or cash on WEEX to potentially profit or diversify your portfolio.',
		},
		{
			title: 'Spend',
			description:
				'Use WEEX Token for direct payments where accepted, or get a Crypto Pay Card (like Bitpay) to instantly convert your crypto to cash for use at millions of merchants or to buy gift cards.',
		},
		{
		...
		},
		{
			...
			description:
				'Research if WEEX Token is used in any platforms, apps, games, or services.',
		},
	]
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WhatCanIDo'>
			<h2 className='text-[32px] font-[500] max-sm:text-[6.4vw]'>
				What Can I Do After I Buy WEEX Token (WXT)?
			</h2>
			...
			<div className='flex mt-[24px] gap-[32px] max-sm:flex-col'>
				...
				<div className='w-[278px] max-sm:w-full'>
					<img
						...
						alt='What Can I Do After I Buy WEEX Token (WXT)?'
