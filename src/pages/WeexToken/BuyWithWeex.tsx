...
const BuyWithWeex: React.FC = () => {
	const items = [
		...
		},
		{
			...
			description:
				'Join over 1000000 users who choose WEEX for their WEEX Token trades.',
		},
		{
			imageUrl: 'https://www.weex.com/_pages/img/buy-weex4.872657e.png',
			title: 'Easy 5-Minute Purchase',
			description:
				'Buy WEEX Token in just minutes with our intuitive platform.',
		},
		{
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WhyBuyWEEX'>
			<h2 className='text-[32px] font-[500] max-sm:text-[6.4vw]'>
				Why Buy WEEX Token With WEEX?
			</h2>

			<p className='mt-[16px] text-[14px]'>
				WEEX Exchange offers a seamless and secure experience for purchasing
				WEEX Token, making it the ideal platform for both beginners and seasoned
				...
				buying WEEX Token today on WEEX and enjoy the best crypto trading
				experience.
			</p>
			...
			<p className='mt-[16px] text-[14px]'>
				Experience the WEEX difference! We make buying WEEX Token secure,
