const WhyBy = () => {
	const whyBuyItems = [
		{
			...
			title: 'Popularity',
			description:
				"With many holders already onboard, WEEX Token is becoming a popular choice for those diving into the crypto universe. Don't miss your chance to be part of this growing community and discover the potential of WEEX Token!",
		},
		{
			icon: 'https://www.weex.com/_pages/img/subtract.8421161.png',
			title: 'Trade Your Way',
			description:
				'WEEX Token gives you the freedom to trade on your terms. Use it for spot and futures trading on both centralized and decentralized exchanges, and put yourself in control of your crypto experience.',
		},
	]
	...
	return (
		<div className='mt-[80px] max-sm:mt-[14.9vw]' id='WhyBuy'>
			...
			>
				Learn more about WEEX Token (WXT)
			</a>
